            ...
            <div className="col-xs-12">
                ...
                <div className="col-xs-12">
                    ...
                    <ul>
                        <li>
                            <h3>
                                <small>We have added two pages (about, members).</small>
                            </h3>
                        </li>
                        <li>
                            <h3>
                                <small>The user can navigate by clicking on links in a common navbar.</small>
                            </h3>
                        </li>
                    </ul>
                    <h3>
                    ...
                    <li className="top-buffer">
                        ...
                        <ul className="top-buffer">
                            <li>
                                <h4>
                                    index.ts:
                                    <small>routes configuration.</small>
                                </h4>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li className="top-buffer">
                        ...
                        <ul className="top-buffer">
                            <li>
                                <h4>
                                    app.tsx:
                                    <small>header + page container.</small>
                                </h4>
                            </li>
                            <li>
                                <h4>
