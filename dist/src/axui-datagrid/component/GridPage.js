...
var GridPage = /** @class */ (function (_super) {
    ...
    GridPage.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classnames_1.default('axd-page'), style: { height: styles.pageHeight } },
            React.createElement("div", { className: classnames_1.default('axd-page-buttons'), style: { width: pageButtonsContainerWidth } }, pageButtons.map(function (button, bi) {
                return (React.createElement("button", { key: bi, style: {
                        height: pageButtonHeight,
                        width: button.width || pageButtonHeight,
                    }, onClick: function (e) { return onClickPageButton(e, button.onClick); } },
