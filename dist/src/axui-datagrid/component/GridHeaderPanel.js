        ...
        return (React.createElement("div", { "data-panel": panelName, style: style },
            React.createElement("table", { style: { height: '100%' } },
                ...
                React.createElement("tbody", null, bodyRow.rows.map(function (row, ri) { return (React.createElement("tr", { key: ri, className: "" },
                    row.cols.map(function (col, ci) { return (React.createElement(GridHeaderCell_1.GridHeaderCell, { key: ci, bodyRow: bodyRow, optionsHeader: optionsHeader, focusedCol: focusedCol, selectionCols: selectionCols, onClickHeader: onClickHeader, sortInfo: sortInfo, ri: ri, col: col })); }),
