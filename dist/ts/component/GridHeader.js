...
class GridHeader extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default('axd-header'), style: { height: styles.headerHeight } },
            (styles.asidePanelWidth > 0) ? react_1.default.createElement(GridHeaderPanel_1.GridHeaderPanel, { panelName: 'aside-header', colGroup: asideColGroup, bodyRow: asideHeaderData, style: asideHeaderPanelStyle, optionsHeader: this.props.optionsHeader, focusedCol: this.props.focusedCol, selectionCols: this.props.selectionCols, onClickHeader: this.props.onClickHeader, sortInfo: this.props.sortInfo, onMouseDownColumnResizer: this.onMouseDownColumnResizer }) : null,
            (frozenColumnIndex > 0) ? react_1.default.createElement(GridHeaderPanel_1.GridHeaderPanel, { panelName: 'left-header', colGroup: leftHeaderColGroup, bodyRow: leftHeaderData, style: leftHeaderPanelStyle, optionsHeader: this.props.optionsHeader, focusedCol: this.props.focusedCol, selectionCols: this.props.selectionCols, onClickHeader: this.props.onClickHeader, sortInfo: this.props.sortInfo, onMouseDownColumnResizer: this.onMouseDownColumnResizer }) : null,
            react_1.default.createElement("div", { "data-scroll-container": 'header-scroll-container', style: headerPanelStyle },
                react_1.default.createElement(GridHeaderPanel_1.GridHeaderPanel, { panelName: 'header-scroll', colGroup: headerColGroup, bodyRow: headerData, style: headerScrollStyle, optionsHeader: this.props.optionsHeader, focusedCol: this.props.focusedCol, selectionCols: this.props.selectionCols, onClickHeader: this.props.onClickHeader, sortInfo: this.props.sortInfo, onMouseDownColumnResizer: this.onMouseDownColumnResizer })),
            this.state.columnResizing ? react_1.default.createElement("div", { "data-column-resizing": true, style: { left: this.state.columnResizerLeft } }) : null));
    }
}
