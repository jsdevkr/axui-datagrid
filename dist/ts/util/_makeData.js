        ...
        for (let c = 0, cl = row.cols.length; c < cl; c++) {
            ...
            if (colStartIndex < _frozenColumnIndex) {
                if (colEndIndex <= _frozenColumnIndex) {
                    ...
                    let leftCol = assignWith_1.default({}, col), rightCol = assignWith_1.default({}, leftCol);
                ...
                tempTable_r.rows[r].cols.push(assignWith_1.default({}, col, {}));
            }
            col = null;
            colStartIndex = null;
            colEndIndex = null;
...
function getTableByStartEndColumnIndex(_table, _startColumnIndex, _endColumnIndex) {
    ...
    if ('rows' in _table) {
        _table.rows.forEach((row, r) => {
            ...
            for (let c = 0, cl = row.cols.length; c < cl; c++) {
                let col = assignWith_1.default({}, row.cols[c]);
