...
const assign_1 = __importDefault(require("lodash-es/assign"));
...
const last_1 = __importDefault(require("lodash-es/last"));
const range_1 = __importDefault(require("lodash-es/range"));
...
class GridRoot extends react_1.default.Component {
    constructor(props) {
        super(props);
        ...
        let defaultState = {
            ...
            options: (() => {
                // todo : 옵션 초기화 함수로 분리
                let options = assign_1.default({}, defaults_1.gridOptions);
                each_1.default(props.options, function (v, k) {
                    options[k] = (isObject_1.default(v)) ? assign_1.default({}, options[k], v) : v;
                });
                return options;
            })()
        };
        this.state = UTIL.propsToState(props, assign_1.default({}, defaultState));
        // state 계산영역 끝
    ...
    static setFormatter(_formatter) {
        return formatter = assign_1.default(formatter, _formatter);
    }
    static getFormatter() {
        return formatter;
    }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (this.props.options !== nextProps.options || this.props.columns !== nextProps.columns) {
            ...
            let newState = assign_1.default({}, this.state, {
                scrollLeft: 0,
                scrollTop: 0,
                options: (() => {
                    let options = assign_1.default({}, defaults_1.gridOptions);
                    each_1.default(nextProps.options, function (v, k) {
                        options[k] = (isObject_1.default(v)) ? assign_1.default({}, options[k], v) : v;
                    });
                    return options;
                })()
    ...
    onResizeColumnResizer(e, col, newWidth) {
        ...
        ({ styles, leftHeaderColGroup, headerColGroup }
            = UTIL.calculateDimensions(this.gridRootNode, { list: this.props.store_list }, assign_1.default({}, this.state, { colGroup: colGroup })));
        this.data._headerColGroup = undefined;
        this.setState({
            colGroup: colGroup,
    ...
    onMouseDownBody(e) {
        ...
        const proc_bodySelect = () => {
            ...
            const onMouseMove = (ee) => {
                ...
                const setStateCall = (currState, _moving) => {
                    ...
                    if (selectEndedCol === -1) {
                        ...
                        const lastCol = last_1.default(this.state.headerColGroup);
            ...
            const throttled_onMouseMove = throttle_1.default(onMouseMove, 10);
        ...
        const proc_clickLinenumber = () => {
            ...
            if (e.shiftKey) {
                state.selectionRows = (() => {
                    let rows = {};
                    range_1.default(Math.min(this.state.focusedRow, selectStartedRow), Math.max(this.state.focusedRow, selectStartedRow) + 1).forEach(i => {
                        rows[i] = true;
                    });
                    return rows;
                })();
    ...
    onKeyPress(e) {
        ...
        const metaProc = {
            [constant_1.KEY_CODE.C]: () => {
                ...
                let copiedString = '';
                each_1.default(this.state.selectionRows, (row, k) => {
                    const item = this.props.store_list.get(k);
                    each_1.default(this.state.selectionCols, (col, ci) => {
            ...
            if (key === 'lineNumber') {
                ...
                if (options.header.clickAction === 'select') {
                    ...
                    if (e.shiftKey) {
                        state.selectionCols = (() => {
                            let cols = {};
                            range_1.default(Math.min(this.state.focusedCol, colIndex), Math.max(this.state.focusedCol, colIndex) + 1).forEach(i => {
                                cols[i] = true;
                            });
                            return cols;
                        })();
    ...
    render() {
        ...
        let gridRootStyle = assign_1.default({ height: this.props.height }, this.props.style);
