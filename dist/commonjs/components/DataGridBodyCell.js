...
var DataGridBodyCell = /** @class */ (function (_super) {
    ...
    DataGridBodyCell.prototype.render = function () {
        var _this = this;
        var _a = this.props, li = _a.li, _b = _a.col, col = _b === void 0 ? {} : _b, _c = _a.col, _d = _c === void 0 ? {} : _c, _e = _d.rowSpan, rowSpan = _e === void 0 ? 0 : _e, _f = _d.colSpan, colSpan = _f === void 0 ? 0 : _f, _g = _d.colIndex, colIndex = _g === void 0 ? 0 : _g, _h = _d.columnAttr, columnAttr = _h === void 0 ? '' : _h, ci = _a.ci, _j = _a.data, data = _j === void 0 ? [] : _j, selected = _a.selected, focusedRow = _a.focusedRow, focusedCol = _a.focusedCol, _k = _a.selectionRows, selectionRows = _k === void 0 ? [] : _k, _l = _a.selectionCols, selectionCols = _l === void 0 ? [] : _l, _m = _a.options, _o = (_m === void 0 ? {} : _m).body, _p = _o === void 0 ? {} : _o, _q = _p.columnHeight, columnHeight = _q === void 0 ? 0 : _q, _r = _p.columnPadding, columnPadding = _r === void 0 ? 0 : _r, _s = _p.columnBorderWidth, columnBorderWidth = _s === void 0 ? 0 : _s, _t = _p.align, bodyAlign = _t === void 0 ? 'left' : _t, _u = _a.isInlineEditing, isInlineEditing = _u === void 0 ? false : _u, _v = _a.inlineEditingCell, inlineEditingCell = _v === void 0 ? {} : _v, _w = _a.predefinedFormatter, predefinedFormatter = _w === void 0 ? {} : _w, setStoreState = _a.setStoreState, dispatch = _a.dispatch;
