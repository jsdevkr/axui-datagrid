...
function calculateDimensions(containerDOM, state, toBeFilteredList) {
    var _a = state.filteredList, filteredList = _a === void 0 ? [] : _a, _b = state.colGroup, colGroup = _b === void 0 ? [] : _b, headerTable = state.headerTable, footSumColumns = state.footSumColumns, _c = state.options, options = _c === void 0 ? {} : _c, _d = state.styles, styles = _d === void 0 ? {} : _d;
    var list = toBeFilteredList || filteredList;
    var _e = options.header, optionsHeader = _e === void 0 ? {} : _e, _f = options.scroller, optionsScroller = _f === void 0 ? {} : _f, _g = options.page, optionsPage = _g === void 0 ? {} : _g;
    var _h = options || {}, _j = _h.frozenColumnIndex, frozenColumnIndex = _j === void 0 ? 0 : _j, _k = _h.frozenRowIndex, frozenRowIndex = _k === void 0 ? 0 : _k;
