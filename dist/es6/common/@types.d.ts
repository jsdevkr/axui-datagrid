...
export declare type formatterFunction = (formatterData: IDataGridFormatterData) => any;
export declare type collectorFunction = (formatterData: IDataGridCollectorData) => any;
export declare type editorFunction = (editorData: IDataGridFormatterData) => void;
export declare type userCallBackFunction = (param?: any) => void;
