...
class DataGridEvents extends React.Component {
    constructor() {
        ...
        this.onKeyDown = (keyAction, e) => {
            const { filteredList = [], headerColGroup = [], scrollLeft = 0, scrollTop = 0, focusedRow = 0, focusedCol = 0, options = {}, styles = {}, setStoreState, colGroup = [], isInlineEditing = false, inlineEditingCell = {}, } = this.props;
        ...
        this.onKeyPress = (e) => {
            const { filteredList = [], getRootNode, getClipBoardNode, colGroup = [], headerColGroup = [], selectionRows = {}, selectionCols = {}, focusedCol = 0, setStoreState, } = this.props;
