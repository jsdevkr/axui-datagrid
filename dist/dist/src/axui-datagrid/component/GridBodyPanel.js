...
var GridBodyPanel = /** @class */ (function (_super) {
    ...
    GridBodyPanel.prototype.render = function () {
        ...
        return (React.createElement("div", { "data-panel": panelName, style: panelStyle }, React.createElement("table", { style: { height: '100%' } }, React.createElement("colgroup", null, panelColGroup.map(function (col, ci) { return (React.createElement("col", { key: ci, style: { width: col._width + 'px' } })); }), React.createElement("col", null)), React.createElement("tbody", null, immutable_1.Range(sRowIndex, eRowIndex).map(function (li) {
            ...
            if (item) {
                return panelBodyRow.rows.map(function (row, ri) {
                    return (React.createElement("tr", { key: ri, className: classnames_1.default(trClassNames) }, row.cols.map(function (col, ci) {
