...
var GridScroll = /** @class */ (function (_super) {
    ...
    GridScroll.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classnames_1.default('axd-scroller') }, verticalScrollerWidth ? (React.createElement("div", { "data-scroll-track": "vertical", style: verticalStyles }, React.createElement("div", { "data-scroll-arrow": "up", style: verticalArrowStyles }, React.createElement("div", { "data-arrow": true, style: verticalTopArrowStyles, onClick: function (e) { return onClickScrollArrow(e, 'up'); } })), React.createElement("div", { "data-scroll": "vertical", onClick: function (e) { return _this.onClickScrollTrack(e, 'vertical'); } }, React.createElement("div", { className: classnames_1.default('axd-scroll-bar'), style: verticalBarStyles, onMouseDown: function (e) { return onMouseDownScrollBar(e, 'vertical'); } })), React.createElement("div", { "data-scroll-arrow": "down", style: verticalArrowStyles }, React.createElement("div", { "data-arrow": true, style: verticalBottomArrowStyles, onClick: function (e) { return onClickScrollArrow(e, 'down'); } })))) : null, horizontalScrollerHeight ? (React.createElement("div", { "data-scroll-track": "horizontal", style: horizontalStyles }, React.createElement("div", { "data-scroll-arrow": "left", style: horizontalArrowStyles }, React.createElement("div", { "data-arrow": true, style: horizontalLeftArrowStyles, onClick: function (e) { return onClickScrollArrow(e, 'left'); } })), React.createElement("div", { "data-scroll": "horizontal", onClick: function (e) { return _this.onClickScrollTrack(e, 'horizontal'); } }, React.createElement("div", { className: classnames_1.default('axd-scroll-bar'), style: horizontalBarStyles, onMouseDown: function (e) { return onMouseDownScrollBar(e, 'horizontal'); } })), React.createElement("div", { "data-scroll-arrow": "right", style: horizontalArrowStyles }, React.createElement("div", { "data-arrow": true, style: horizontalRightArrowStyles, onClick: function (e) { return onClickScrollArrow(e, 'right'); } })))) : null));
    };
    return GridScroll;
}(React.Component));
