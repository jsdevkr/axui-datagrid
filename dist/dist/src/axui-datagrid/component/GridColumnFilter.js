...
var GridColumnFilter = /** @class */ (function (_super) {
    ...
    GridColumnFilter.prototype.render = function () {
        ...
        return (React.createElement("div", { "data-column-filter": "true", className: classnames_1.default('axd-column-filter'), style: filterStyles }, React.createElement(GridColumnFilterOption_1.GridColumnFilterOption, { options: filterOptions, onChange: function (value, checked, checkAll) {
