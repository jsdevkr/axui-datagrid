...
var Index = /** @class */ (function (_super) {
    ...
    Index.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null, React.createElement("header", { className: 'app-header' }, React.createElement(semantic_ui_react_1.Container, null, React.createElement("div", { className: 'logo-img' }, React.createElement("img", { src: axuiLogo })), React.createElement("h1", null, "axui-datagrid"), React.createElement("div", null, React.createElement(GitHubButton, { type: "stargazers", size: "large", namespace: "axui", repo: "axui-datagrid" }), ' ', React.createElement(GitHubButton, { type: "forks", size: "large", namespace: "axui", repo: "axui-datagrid" })))), React.createElement(semantic_ui_react_1.Container, null, React.createElement(semantic_ui_react_1.Grid, { padded: true }, React.createElement(semantic_ui_react_1.Grid.Row, null, React.createElement(semantic_ui_react_1.Grid.Column, null, React.createElement(semantic_ui_react_1.Header, { as: "h2" }, "Installation"), React.createElement(components_1.CodeViewer, null, "npm install axui-datagrid -S"), React.createElement(components_1.CodeViewer, { code: "\nimport 'axui-datagrid/style.css';\nimport { AXDataGrid } from 'axui-datagrid';\n" }))), React.createElement(semantic_ui_react_1.Grid.Row, null, React.createElement(semantic_ui_react_1.Grid.Column, null, React.createElement(semantic_ui_react_1.Header, { as: "h2" }, "basic"), React.createElement(Examples_1.Basic, null), React.createElement(semantic_ui_react_1.Checkbox, { label: "Show Code", checked: viewBasicRaw, onChange: function (e, data) {
