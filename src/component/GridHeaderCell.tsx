...
export class GridHeaderCell extends React.Component<
  iAXDataGridHeaderCellProps,
  iAXDataGridHeaderCellState
> {
  ...
  public render() {
    ...
    let cellHeight =
      optionsHeader.columnHeight * col.rowspan -
      optionsHeader.columnBorderWidth;
    let tdClassNames = {
    ...
    return (
      ...
      >
        ...
        {optionsHeader.enableFilter && col.key && col.colIndex > -1 ? (
